...
/*
 * Canonical DB access for proposal drafts.
 */
require_once AIJP_PLUGIN_PATH . 'includes/class-proposal-repository.php';

/*
 * Proposal prompt definitions.
 */
require_once AIJP_PLUGIN_PATH . 'includes/class-proposal-prompts.php';

/*
 * Orchestrates AI generation + persistence for proposal drafts.
 */
require_once AIJP_PLUGIN_PATH . 'includes/class-proposal-service.php';
